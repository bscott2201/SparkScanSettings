...
import static com.scandit.datacapture.barcode.data.CapturePreset.RETAIL;
...
public class MainActivity extends CameraPermissionActivity implements SparkScanListener, SparkScanFeedbackDelegate {
    ...
    public static final String SCANDIT_LICENSE_KEY = "ADD HERE";
    ...
    private void initialize() {
        ...
        SparkScanSettings sparkScanSettings = new SparkScanSettings(Collections.singleton(RETAIL));
...
//        symbologySettings.setActiveSymbolCounts(activeSymbolCounts);
        ...
        settings.setTriggerButtonCollapseTimeout(TimeInterval.millis(5000));
        ...
        // Color Customization
//        sparkScanView.setCaptureButtonBackgroundColor(Color.BLUE); // Collapsed Button
//        sparkScanView.setCaptureButtonActiveBackgroundColor(Color.BLUE); // Expanded Button
//        sparkScanView.setCaptureButtonTintColor(Color.RED); // Direction Ring
//        sparkScanView.setToolbarBackgroundColor(Color.GREEN); // Toolbar

        // Toolbar
//        sparkScanView.setTargetModeButtonVisible(true);
//        sparkScanView.setScanningBehaviorButtonVisible(true);
